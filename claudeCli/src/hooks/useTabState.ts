...
interface UseTabStateReturn {
  ...
  createClaudeFileTab: (fileId: string, fileName: string, fileData?: ClaudeMdFile) => string;
...
export const useTabState = (): UseTabStateReturn => {
  ...
  const createClaudeFileTab = useCallback(
    (fileId: string, fileName: string, fileData?: ClaudeMdFile): string => {
