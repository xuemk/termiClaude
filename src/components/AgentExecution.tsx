...
export const AgentExecution: React.FC<AgentExecutionProps> = ({ agent, onBack, className }) => {
  ...
  useEffect(() => {
    ...
    const handleModelSelectionUpdate = () => {
      logger.info("[AgentExecution] Model selection updated event received, reloading models...");
      loadModels();
    };

    const handleEnvironmentGroupsUpdate = () => {
      logger.info("[AgentExecution] Environment groups updated event received, reloading models...");
      loadModels();
    };
