...
export const en: Translations = {
  ...
  settings: {
    ...
    messageDisplayModeDesc: "Choose your Claude Code interaction experience mode",
    showCmdMode: "CMD Mode",
    showEnhancedMode: "Enhanced Mode",
    showHybridMode: "Hybrid Mode",
    showTerminalMode: "Compatibility Mode",
    showToolCallsOnly: "Concise Mode",
    showBoth: "Full Mode",
    showCmdModeDesc: "Pure black-green terminal style, fully mimics command-line experience, <100ms delay",
    showEnhancedModeDesc: "Preserve syntax highlighting and tool panels, balance features with performance",
    showHybridModeDesc: "Switchable dual experience, Ctrl+T to toggle (Recommended)",
    showTerminalModeDesc: "Render streaming output with minimal formatting, similar to using Claude Code in a terminal",
