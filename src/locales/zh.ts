...
export const zh: Translations = {
  ...
  settings: {
    ...
    messageDisplayModeDesc: "选择Claude Code的交互体验模式",
    showCmdMode: "CMD模式",
    showEnhancedMode: "增强模式",
    showHybridMode: "混合模式",
    showTerminalMode: "兼容模式",
    showToolCallsOnly: "简洁模式",
    showBoth: "完整模式",
    showCmdModeDesc: "纯黑绿终端风格，完全模拟命令行体验，<100ms延迟",
    showEnhancedModeDesc: "保留语法高亮和工具面板，平衡功能与性能",
    showHybridModeDesc: "可切换的双重体验，快捷键Ctrl+T切换（推荐）",
    showTerminalModeDesc: "以接近命令行的方式流式渲染输出，获取最小延迟的阅读体验",
