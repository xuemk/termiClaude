...
export interface Translations {
  ...
  settings: {
    ...
    showCmdMode: string;
    showEnhancedMode: string;
    showHybridMode: string;
    showTerminalMode: string;
    showToolCallsOnly: string;
    showBoth: string;
    showCmdModeDesc: string;
    showEnhancedModeDesc: string;
    showHybridModeDesc: string;
    showTerminalModeDesc: string;
